...
<body> 
    <section class="header">
        <nav>
			<h2 style="margin-left: 1%; text-decoration: underline dotted; color: #ffffff; text-shadow: 2px 2px 2px #DC143C;">Repair Policy</h2>		
	        <a href="HOME.php" id="A9-STORE-logo" style="margin-left: 33.6%;">
	            <div>
	    ...
	    <div class="location-div-main" style="width: 12%;margin-left: 1%;">
	        <div id="location-div" style="text-align: center; padding: 5px 3px;">
	            <h6><a href="HOME.php">Home</a> > Repair Policy</h6>
	        </div>
	    </div>
       	<div class="terms-of-use-main-div">
            <div class="terms-of-use-div-1" style="padding: 20px 20px;">
			    <p style="color: orange;">
				    Read the terms carefully before accessing the site.
			        It's for users wellfare & ease to shop from the site.<br>
				    All the following terms will help you to figure out how to access this platform and its features.<br><br>
				    <li style="color: #ffffff;">
					    A9 STORE :<br> A9 STORE is a 21<sup>st</sup> century based online shopping,<br> site that deals with the women's lower extremity,<br> from the knee to the foot in various departments.
						<a href="ABOUT.php" title="More" style="text-decoration: none;"><button id="know-more-button-terms-of-use" type="button">Know More</button></a>
				    </li>
				</p><br>
                <p style="color: orange;">				
					The website A9 STORE.com, Inc is designed & operated by A9 STORE Private Limited<br>
					('one to two lines of gap for address')<br><br>
					Site's all functionalities are handle by A9 STORE, here the down written terms will help you to<br> easily access this website & for any further enquiry you can kindly contact us through this way <i class="fa fa-road" id="fa-road"></i><br><br>
					A9 STORE do not share your details and information that you provide to A9 STORE for further escalating<br> the processing with any third party for any sale purpose. All the designs & outputs are made by A9 Brand<br> that comes under A9 STORE
				</p>
            </div>		    
        </div>
        <div class="more-locations">
		    <h5 style="text-decoration: underline dotted;">Repair Policy</h5>
			<a href="Terms-of-use.php" style="color: #ffffff; text-decoration: none;"><h5 style="text-align: center; color: #ffffff;">Terms Of Use</h5></a>			
			<a href="Return-policy.php" style="color: #ffffff; text-decoration: none;"><h5 style="text-align: center; color: #ffffff;">Return Policy</h5></a>
			<a href="Privacy-policy.php" style="color: #ffffff; text-decoration: none;"><h5 style="text-align: center; color: #ffffff;">Privacy Policy</h5></a>		
			<a href="Exchange-policy.php" style="color: #ffffff; text-decoration: none;"><h5 style="text-align: right; color: #ffffff;">Exchnage Policy</h5></a>				
        </div>	
	...
	<nav>
	    <div class="nav-links-main-div" style="margin-top: 17.7%;">
