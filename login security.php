...
<body onload="loginfunction()">
    <section class="header4">
        <nav>
			<h2 style="margin-left: 1%; text-decoration: underline dotted; color: #ffffff; text-shadow: 2px 2px 2px #DC143C;">My Details</h2>		
		...
		<div id="location-div">
			<h1 style="text-shadow: 1.5px 1.5px 1.5px #ffff00; color: #DC134C; margin-top: 2%;">My Details</h1>
			<div style="box-shadow: 0px 0px 10px 2px #ffff00; width: 10%; height: 2px;"></div>
		</div>
        <table class="login-security-main-div">
		    <tr>
			   <th>Name</th>
			   <td id="td-login-security-main-div"><i class="fa fa-info-circle"></i> No Data ! <button id="edit-button">Edit</button></td>
			</tr>
		    <tr>
			   <th>E-Mail</th>
			   <td id="td-login-security-main-div"><i class="fa fa-info-circle"></i> No Data ! <button id="edit-button">Edit</button></td>
            ...
            <td><button id="save-edit-button">Save</button></td>			
        </table>	
        <div id="user-login" style="margin-top: -5%; margin-left: 36%;">
        ...
        <div id="create-an-account-div" style="margin-top: -5%; margin-left: 36%;">
