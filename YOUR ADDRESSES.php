...
<body>
    <nav class="heading">
	    <a href="HOME.php" id="A9-STORE-logo" style="margin-left: 47%;">
	        <div>
    ...
    <section class="header">
        <div id="location-div" style="text-align: center; padding: 5px 3px;">
		    <h6><a href="HOME.php">Home</a> > <a href="YOUR ACCOUNT.php">MY ACCOUNT</a> > MY ADDRESSES</h6>
		</div>		
	    <div class="pages">
		    <a href=""><div class="page1">
			    <span class="address-logo"><i id="allicon" class="fa fa-address-book-o"></i></span>
			    <h1>ADD NEW ADDRESS</h1>
			</div></a>
        </div> 
	    <div class="pages2">
		    <div class="page2">
			        <span><img id="logocircle" src="Images/A9-STORE.jpg"/></span>
			        <span class="default">Default Address</span>
			            <div class="lineseparate2"></div>
					<ul>	
				        <li class="default-deatil">Name :</li>
					    <li class="default-deatil">Pincode :</li>
					    <li class="default-deatil">Address :</li>
					    <li class="default-deatil">Phone Number :</li>
					</ul>	
					<div class="lineseparate3">
					</div>
					<a href="RESIDENCE.php" class="edit">Edit Default Address</a>
					<a href="RESIDENCE.php" class="edit">Edit Default Address</a>
					<a href="" class="delete">Delete Default Address</a>
			</div>
        </div> 	
