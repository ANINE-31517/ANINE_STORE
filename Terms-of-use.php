...
<body> 
    <section class="header">
        <nav>
			<h2 style="margin-left: 1%; text-decoration: underline dotted; color: #ffffff; text-shadow: 2px 2px 2px #DC143C;">TERMS OF USE</h2>		
	    ...
	    <div class="location-div-main" style="width: 12%;margin-left: 1%;">
	        <div id="location-div" style="text-align: center; padding: 5px 3px;">
	            <h6><a href="HOME.php">Home</a> > Terms Of Use</h6>
	        </div>
	    </div>
        ...
        <div class="more-locations">
		    <h5 style="text-decoration: underline dotted;">Terms Of Use</h5>
			...
			<a href="Repair-policy.php" style="color: #ffffff; text-decoration: none;"><h5 style="text-align: center; color: #ffffff;">Repair Policy</h5></a>
