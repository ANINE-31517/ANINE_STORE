...
<body>
    ...
    <section class="header">
	    <!-- logo-runner-start -->
	    <div class="logo-runner" id="logo-runner"></div>
		<script type="text/javascript">
            setTimeout(function(){
			    document.getElementById("logo-runner").style.display = "none";
			}, 2000);
			setTimeout(function(){
			    document.getElementById("login-message-on-page-load").style.display = "none";
			}, 8000);
		</script>
		<!-- logo-runner-end -->
		<!-- navigation-1-start -->
        ...
        <!-- navigation-1-end -->		
		    ...
		    <!-- login-message-on-page-load -->
            <div id="login-message-on-page-load" class="login-message-on-page-load">
			    <div>Click to Signin</div>
				<div>
                    <span>New Customer ?</span> <button id="signup-from-login-message">Signup</button>		
                </div>				
            </div>				
            <div id="overlay"></div>
            <script type="text/javascript">
		...
		<!-- navigation-2-end -->
            ...
            <div id="user-login">
				...
				<div id="label-input-div-of-login">
				    <form action="HOME-2.php" method="POST">
				        <label id="label1" style="text-shadow: 1px 1px 1px #ffff00;" for="email_number_input">Enter Email/Mobile Number</label>
					    <input style="text-align: center;" id="email-number-input" type="text" name="email_number_input" autocomplete="off" />
						...
						<span id="field-validation-0" style="font-size: 11px; color: #ff0000; font-weight: bold; display: none;"><i class="fa fa-info-circle"></i> Invalid E-Mail !</span>
				        <fieldset id="login-password-fieldset">	
					        ...
					        <span><input style="width: 90%; text-align: center;" type="password" name="password_input" id="login-password"  autocomplete="off" /><i id="login-password-icon" style="cursor: pointer; padding: 4px 4px;" class="bi bi-eye-slash"></i></span>
                        ...
                        <div style="margin-top: 5px; box-shadow: 0px 1px 3px 2px #DC134C; display: none; font-size: 11px; color: #DC134C; text-shadow: 1px 1px 1px #ffd700; border-radius: 5px; border: 2px solid RGB(239, 192, 80);" id="why">
						    <strong>You would have got a message or an email on which your OTP<br>(one time password) would be written.<br>Why : This is for the user's security so that no other can manipulate with your account.</strong>
						</div>						
