...
<body> 
    <section class="header">
        <nav>
			<h2 style="margin-left: 1%; text-decoration: underline dotted; color: #ffffff; text-shadow: 2px 2px 2px #DC143C;">Return Policy</h2>		
	    ...
	    <div class="location-div-main" style="width: 12%;margin-left: 1%;">
	        <div id="location-div" style="text-align: center; padding: 5px 3px;">
	            <h6><a href="HOME.php">Home</a> > Return Policy</h6>
	        </div>
	    </div>
        ...
        <div class="more-locations">
		    <h5 style="text-decoration: underline dotted;">Return Policy</h5>
