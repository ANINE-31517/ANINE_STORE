...
<body onload="loginfunction()">
    <section class="header4">
        <nav>
			<h2 style="margin-left: 1%; text-decoration: underline dotted; color: #ffffff; text-shadow: 2px 2px 2px #DC143C;">My Wishlist</h2>		
	    ...
	    <div class="location-div-main" style="width: 13%; margin-left: 1%;">
	        <div id="location-div" style="text-align: center; padding: 5px 3px;">
	            <h6><a href="HOME.php">Home</a> > My Wishlist</h6>
	        </div>
	    </div>		
        ...
        <div class="main-wishlist-div">
		    <h4 style="text-align: center; text-shadow: 1px 1px 1px #DC143C;">Wishlist () <i class="fa fa-heart" style="color: #ff0000;"></i></h4>
			<div style="width: 10%; height: 2px; box-shadow: 0px 0px 10px 2px #ff0000; margin-left: 45%;"></div>
			<div id="main-wishlist-div-h5-h6">
			    <h5 id="main-wishlist-div-h5"><i class="fa fa-info-circle"></i> Wishlist is empty!</h5>
			    <a href="HOME.php" style=" color: #000000;"><h6 id="main-wishlist-div-h6">Start adding now</h6></a>
			</div>
		    <div style="background: rgba(255, 165, 0); box-shadow: 0px 0px 10px 2px rgba(255, 165, 0); height: 85%; width: 2px; margin-left: 2%; margin-top: -13.5%; position: absolute;"></div>
		    <div style="background: rgba(255, 165, 0); box-shadow: 0px 0px 10px 2px rgba(255, 165, 0); height: 85%; width: 2px; margin-left: 96%; margin-top: -13.5%; position: absolute;"></div>							
        </div>	
        <div id="user-login" style="margin-top: 0%; margin-left: 36%;">
			...
			<div id="label-input-div-of-login">
			    <form action="Wishlist-2.php" method="Post">
