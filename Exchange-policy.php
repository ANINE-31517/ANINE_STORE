...
<body> 
    <section class="header">
        <nav>
			<h2 style="margin-left: 1%; text-decoration: underline dotted; color: #ffffff; text-shadow: 2px 2px 2px #DC143C;">Exchnage Policy</h2>		
	    ...
	    <div class="location-div-main" style="width: 12%;margin-left: 1%;">
	        <div id="location-div" style="text-align: center; padding: 5px 3px;">
	            <h6><a href="HOME.php">Home</a> > Exchnage Policy</h6>
	        </div>
	    </div>
       	<div class="terms-of-use-main-div">
            <div class="terms-of-use-div-1" style="padding: 20px 20px;">
			    <p style="color: orange;">
                    There are few terms that will clear out the Return Policy of A9 STORE.com, Inc
				</p>
            </div>		    
        </div>
        <div class="more-locations">
		    <h5 style="text-decoration: underline dotted;">Exchnage Policy</h5>
			...
			<a href="Return-policy.php" style="color: #ffffff; text-decoration: none;"><h5 style="text-align: right; color: #ffffff;">Return Policy</h5></a>		
        </div>	
