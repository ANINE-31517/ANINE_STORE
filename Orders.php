...
<body onload="loginfunction()"> 
    <section class="header6">
        <nav>
			<h2 style="margin-left: 1%; text-decoration: underline dotted; color: #ffffff; text-shadow: 2px 2px 2px #DC143C;">My Orders</h2>		
	        <a href="HOME.php" id="A9-STORE-logo" style="margin-left: 37%;">
	            <div>
	    ...
	    <div class="location-div-main" style="width: 13%; margin-left: 1%;">
	        <div id="location-div" style="text-align: center; padding: 5px 3px;">
	            <h6><a href="HOME.php">Home</a> > My Orders</h6>
	        </div>
	    </div>
		<div style="position: absolute; top: 9%; width: 4px; height: 90%; background: linear-gradient(0deg, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0.5) 5%, rgba(0, 0, 0, 0.7) 10%, RGB(239, 192, 80) 100%);  margin-left: 15%;"></div>									
       	<div class="orders-main-div">
            <div class="orders-contents-1">
			    <h3 style="text-shadow: 1px 1px 1px #DC143C; text-align: center; padding: 3px 3px;">Orders <i class="fa fa-shopping-bag"></i> <span>()</span></h3>
				<div style="box-shadow: 0px 0px 10px 2px #ffff00; width: 11%; margin-left: 45%; height: 3px;"></div>
            </div>	
			<div style="margin-top: 10%;; text-shadow: 1px 1px 1px #ff0000;">
			    <h4 style="text-align: center;">Sorry to say but, you have not ordered any design from our STORE.</h4>
				<a href="HOME.php" id="order-today"><h5>Let's take a step forward & order today.</h5></a>
			</div>
		    <div style="background: rgba(255, 165, 0); box-shadow: 0px 0px 10px 2px rgba(255, 165, 0); height: 88%; width: 2px; margin-left: 2%; margin-top: -16%; position: absolute;"></div>
		    <div style="background: rgba(255, 165, 0); box-shadow: 0px 0px 10px 2px rgba(255, 165, 0); height: 88%; width: 2px; margin-left: 98%; margin-top: -16%; position: absolute;"></div>										
        </div>	
        <div id="user-login" style="margin-top: 0%; margin-left: 36%;">
		    <h1 style="background: rgba(255, 165, 0); text-shadow: 2px 2px 2px #DC143C;">Login</h1>
			<div id="label-input-div-of-login">
			    <form action="Orders-2.php" method="Post">
			        <label id="label1" style="text-shadow: 1px 1px 1px #ffff00;" for="email_number_input">Enter Email/Mobile Number</label>
				    <input id="email-number-input" type="text" name="email_number_input" autocomplete="off" />
			        ...
			        <fieldset id="login-password-fieldset">	
				        ...
				        <label id="label2" style="text-shadow: 1px 1px 1px #ffff00;" for="password_input">Enter Password</label>
				        <span><input style="width: 90%;" type="password" name="password_input" id="login-password"  autocomplete="off" /><i id="login-password-icon" style="cursor: pointer; padding: 4px 4px;" class="bi bi-eye-slash"></i></span>
        ...
        <div style="background: rgba(0, 0, 0, 1);" id="A9-STORE-overlay"></div>			
        <div id="create-an-account-div" style="margin-top: 0%; margin-left: 36%;">
	...
	<nav>
	    ...
	    <div class="running-time">
		    <h6>&#169; 2021-2022 , A9 STORE.com, Inc. | <a href="">Terms Of Use</a> | <a href="">Privacy Policy</a> | <a href="">Return Policy</a></h6>
		</div>		
	</nav>
