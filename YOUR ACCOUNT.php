...
<body>
    ...
    <section class="header">
	    <div id="location-div" style="text-align: center; padding: 5px 3px;">
	        <h6><a href="HOME.php">Home</a> > My Account</h6>
	    </div>
	    <div class="pages">
		    <a href="YOUR ADDRESSES.php"><div class="page1">
			    <span class="div-logo"><i id="allicon" class="fa fa-address-book-o"></i></span>
			    <h1>MY ADDRESSES</h1>
				<p>check or edit your addresses</p>
			</div></a>
        </div> 
	    <div class="pages2">
		    <a href="login security.php"><div class="page2">
			    <span class="div-logo"><i id="allicon" class="fa fa-lock"></i></i></span>
			    <h1>LOGIN SECURITY</h1>
				<p>check or edit your login credentials</p>
			</div></a>
        </div> 
	    <div class="pages3">
		    <a href="Orders.php"><div class="page3">
			    <span class="div-logo"><i id="allicon" class="fa fa-shopping-bag"></i></span>
			    <h1>MY ORDERS</h1>
				<p>your orders</p>
			</div></a>
        </div>
