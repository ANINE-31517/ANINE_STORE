...
<body>
    <section class="header" style="min-height: 250vh;">
	    <nav class="nav1">
		    <div class="search-in">
		...
		<div class="left-side-fixed-div">
		    <div class="location-div-main" style="margin-top: 10%;">
		        <div id="location-div" style="text-align: center; padding: 5px 3px;">
		            <h6><a href="HOME.php">Home</a> > Today's Offers</h6>
		        </div>
		    </div>
        </div>	
		<div style="position: absolute; margin-top: 7.3%; width: 4px; height: 230%; background: linear-gradient(0deg, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.5) 5%, rgba(255, 165, 0) 100%); margin-left: 18%;"></div>							
		<div style="position: absolute; margin-top: 14%; width: 100%; height: 4px; background: linear-gradient(100deg, rgba(0 ,0 ,0, 1) 0%, rgba(255, 165, 0) 6%, rgba(0, 0, 0, 0.5) 99%, rgba(0, 0, 0, 0.7)) 100%; left: -1%;"></div>							
        <div id="pagenumber-1-all-details">				
		    <div class="title-of-main-div">
		        <h3>Today's Offers</h3>
				<div style="height: 100%; width: 3px; background: #ffffff; margin-left: 75%; top: 0; position: absolute;"></div>
				<div id="timeout-clock" style="margin-left: 77%; margin-top: 2%; width: 15%; height: 32%;"></div>
		    </div>
		    <div class="main-div-all-designs" style="margin-top: 14.5%; height: 200%;"> 	
                <div class="main-div-all-designs-sub-1-of-offers">	
                    <div class="super-main-div-design-img-div-of-offers" id="super-main-div-design-img-div-of-offers-1">													
		                <a href="Stilettoes-offers.php" style="text-decoration: none"><div id="sub-super-main-div-design-img-div-of-offers"></div>
						<div id="sub-2-super-main-div-design-img-div-of-offers"></div>								
						<div id="sub-3-super-main-div-design-img-div-of-offers"><div id="heading-offers">Stilettoes</div></div>	
                        <div id="sub-4-super-main-div-design-img-div-of-offers"></div>	
                        <div id="arrow-down-1-div"><span class="cart-empty-tooltip-1" id="cart-empty-tooltip-1">Stilettoes</span></div></a>								
					</div>
                    <div class="super-main-div-design-img-div-of-offers" id="super-main-div-design-img-div-of-offers-2" style="margin-left: 15%;">													
		                <a href="High-Heels-offers.php" style="text-decoration: none"><div id="sub-super-main-div-design-img-div-of-offers"></div>
						<div id="sub-2-super-main-div-design-img-div-of-offers"></div>								
						<div id="sub-3-super-main-div-design-img-div-of-offers"><div id="heading-offers">High Heels</div></div>
						<div id="sub-4-super-main-div-design-img-div-of-offers"></div>
                        <div id="arrow-down-1-div"><span class="cart-empty-tooltip-2" id="cart-empty-tooltip-2">High Heels</span></div></a>								
					</div>							
		    	</div>
		    	<div class="main-div-all-designs-sub-2-of-offers">
                    <div class="super-main-div-design-img-div-of-offers" id="super-main-div-design-img-div-of-offers-3">													
		                <a href="Wedges-offers.php" style="text-decoration: none"><div id="sub-super-main-div-design-img-div-of-offers"></div>
						<div id="sub-2-super-main-div-design-img-div-of-offers"></div>								
						<div id="sub-3-super-main-div-design-img-div-of-offers"><div id="heading-offers">Wedges</div></div>		
                        <div id="sub-4-super-main-div-design-img-div-of-offers"></div>	
                        <div id="arrow-down-1-div"><span class="cart-empty-tooltip-3" id="cart-empty-tooltip-3">Wedges</span></div></a>								
					</div>
                    <div class="super-main-div-design-img-div-of-offers" id="super-main-div-design-img-div-of-offers-4" style="margin-left: 15%;">													
		                <a href="Heeled-Boots-offers.php" style="text-decoration: none"><div id="sub-super-main-div-design-img-div-of-offers"></div>
						<div id="sub-2-super-main-div-design-img-div-of-offers"></div>								
						<div id="sub-3-super-main-div-design-img-div-of-offers"><div id="heading-offers">Heeled Boots</div></div>
						<div id="sub-4-super-main-div-design-img-div-of-offers"></div>
                        <div id="arrow-down-1-div"><span class="cart-empty-tooltip-4" id="cart-empty-tooltip-4">Heeled Boots</span></div></a>								
					</div>
                </div>	
		    	<div class="main-div-all-designs-sub-3-of-offers">
                    <div class="super-main-div-design-img-div-of-offers" id="super-main-div-design-img-div-of-offers-5">													
		                <a href="Ankle-Straps-offers.php" style="text-decoration: none"><div id="sub-super-main-div-design-img-div-of-offers"></div>
						<div id="sub-2-super-main-div-design-img-div-of-offers"></div>								
						<div id="sub-3-super-main-div-design-img-div-of-offers"><div id="heading-offers">Ankle Straps</div></div>	
                        <div id="sub-4-super-main-div-design-img-div-of-offers"></div>								
                        <div id="arrow-down-1-div"><span class="cart-empty-tooltip-5" id="cart-empty-tooltip-5">Ankle Straps</span></div></a>								
					</div>
                    <div class="super-main-div-design-img-div-of-offers" id="super-main-div-design-img-div-of-offers-6" style="margin-left: 15%;">													
		                <a href="T-Straps-offers.php" style="text-decoration: none"><div id="sub-super-main-div-design-img-div-of-offers"></div>
						<div id="sub-2-super-main-div-design-img-div-of-offers"></div>								
						<div id="sub-3-super-main-div-design-img-div-of-offers"><div id="heading-offers">T Straps</div></div>
						<div id="sub-4-super-main-div-design-img-div-of-offers"></div>
                        <div id="arrow-down-1-div"><span class="cart-empty-tooltip-6" id="cart-empty-tooltip-6">T Straps</span></div></a>								
					</div>
                </div>
            </div>						
		</div>											
	...
	<script>
		...
		var click = document.getElementById('super-main-div-design-img-div-of-offers-1');
        click.addEventListener('mouseover', function(){
			document.getElementById('cart-empty-tooltip-1').style.visibility = "visible";
		});	
        click.addEventListener('mouseleave', function(){
			document.getElementById('cart-empty-tooltip-1').style.visibility = "hidden";
		});	
		var click = document.getElementById('super-main-div-design-img-div-of-offers-2');
        click.addEventListener('mouseover', function(){
			document.getElementById('cart-empty-tooltip-2').style.visibility = "visible";
		});	
        click.addEventListener('mouseleave', function(){
			document.getElementById('cart-empty-tooltip-2').style.visibility = "hidden";
		});	
		var click = document.getElementById('super-main-div-design-img-div-of-offers-3');
        click.addEventListener('mouseover', function(){
			document.getElementById('cart-empty-tooltip-3').style.visibility = "visible";
		});	
        click.addEventListener('mouseleave', function(){
			document.getElementById('cart-empty-tooltip-3').style.visibility = "hidden";
		});		
		var click = document.getElementById('super-main-div-design-img-div-of-offers-4');
        click.addEventListener('mouseover', function(){
			document.getElementById('cart-empty-tooltip-4').style.visibility = "visible";
		});	
        click.addEventListener('mouseleave', function(){
			document.getElementById('cart-empty-tooltip-4').style.visibility = "hidden";
		});	
		var click = document.getElementById('super-main-div-design-img-div-of-offers-5');
        click.addEventListener('mouseover', function(){
			document.getElementById('cart-empty-tooltip-5').style.visibility = "visible";
		});	
        click.addEventListener('mouseleave', function(){
			document.getElementById('cart-empty-tooltip-5').style.visibility = "hidden";
		});	
		var click = document.getElementById('super-main-div-design-img-div-of-offers-6');
        click.addEventListener('mouseover', function(){
			document.getElementById('cart-empty-tooltip-6').style.visibility = "visible";
		});	
        click.addEventListener('mouseleave', function(){
			document.getElementById('cart-empty-tooltip-6').style.visibility = "hidden";
		});		
