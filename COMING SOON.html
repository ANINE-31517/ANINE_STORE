    ...
    <section class="header" style="min-height: 250vh;">
		...
		<div class="left-side-fixed-div">
		    <div class="location-div-main" style="margin-top: 10%;">
		        <div id="location-div" style="text-align: center; padding: 5px 3px;">
		            <h6><a href="HOME.php">Home</a> > Coming Soon</h6>
		        </div>
		    </div>
        </div>	
        ...
        <div id="pagenumber-1-all-details">				
		    <div class="title-of-main-div">
				...
				<div id="timeout-clock" style="margin-left: 77%; margin-top: 2%;">Date : Meta</div>						
		    </div>	
        </div>
		<div class="main-div-all-designs" style="margin-top: 14.5%; height: 200%; background: linear-gradient(0deg, #ffffff 0%, rgba(0 ,0, 0, 0.3) 15%, rgba(0, 0, 0, 0.5) 95%, transparent 100%);"> 
          	<div class="coming-soon-image-1-div">
			    <img src="images/coming-soon-img-1.jpg" />
				<div class="lights-div-for-image-1"></div>
				<div class="lights-div-for-image-2"></div>
				<div class="lights-div-for-image-3"></div>
				<div class="lights-div-for-image-4"></div>
			</div>	
          	<div class="coming-soon-image-2-div">
			    <img src="images/coming-soon-img-2.jpg" />
				<div class="lights-div-for-image-1"></div>
				<div class="lights-div-for-image-2"></div>
				<div class="lights-div-for-image-3"></div>
				<div class="lights-div-for-image-4"></div>
